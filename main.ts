...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite2, otherSprite2) {
    ...
    myEnemy = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Enemy)
    myEnemy.setPosition(149, randint(0, 120))
})
...
myHero = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Player)
for (let myEnemy2 = 0; myEnemy2 <= 4; myEnemy2++) {
    myEnemy2 += 1
}
scene.cameraFollowSprite(myHero)
controller.moveSprite(myHero, 100, 100)
myEnemy = sprites.create(img`
    ........................
    ........................
    ........................
    ...
    ........................
    `, SpriteKind.Enemy)
myHero.setPosition(10, 54)
myEnemy.setPosition(149, 82)
forever(function () {
    myEnemy.setVelocity(-42, 0)
})
forever(function () {
